...
public class FishSatchelItem extends AbstractTooltipItem {
        //? if >=26.2 {
        private static final int BAR_COLOR = Mth.hsvToRgb(0.4f, 0.4f, 1.0f);
        //?} else {
        /*
        ...
        */
        ...
        public @NotNull Optional<TooltipComponent> getTooltipImage(ItemStack stack) {
                TooltipDisplay tooltipDisplay = stack.getOrDefault(
                ...
                SatchelContents contents = TideItemData.SATCHEL_CONTENTS.getOrDefault(
                        stack, 
                        new SatchelContents()
                );
        ...
        */
        ...
        public void addTooltip(DataComponentGetter getter, Consumer<Component> tooltip) {
                ...
                SatchelContents contents = getter.get(TideDataComponents.SATCHEL_CONTENTS);
        //?} else {
        /*
